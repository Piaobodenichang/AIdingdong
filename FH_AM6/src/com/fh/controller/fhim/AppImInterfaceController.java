 ...
 */
@Controller
@RequestMapping(value="/appiminterface")
public class AppImInterfaceController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/appim")
	public ModelAndView edit() throws Exception{
		ModelAndView mv = this.getModelAndView();
		mv.setViewName("appweb/mobile");
		return mv;
	}
	...
	public Object getList() throws Exception{
		...
		return AppUtil.returnObject(pd, nmap);
	}

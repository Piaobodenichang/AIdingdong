...
<table border="5" style="margin-top: 10px;margin-left: 10px;"bordercolor="#F2F2F2">
<tr>
<td>				
<div class="wx-main">
<!--左部分-->
...
<tr>
<td><font color="#E59729">返回码说明：<a href="http://qydev.weixin.qq.com/wiki/index.php?title=全局返回码说明" target="_bank">查看返回码</a>(有返回码说明功能正常,只是参数配置问题,具体根据返回码看说明)</font></td>
</tr>
</table>
</body>
<!--提示框-->

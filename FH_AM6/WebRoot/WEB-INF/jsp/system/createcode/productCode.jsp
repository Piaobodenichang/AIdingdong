...
<html lang="en">
	<head>
		...
		.commitbox_top{width:100%; height:258px; margin-bottom:10px; padding-top:10px; background:#FFF; border-radius:5px; box-shadow:1px 1px 3px #e8e8e8;}
						  	...
						  	<div class="commitbox_inner">
						        <div class="commitbox_top">
						        	...
						        	<table>
						        		...
						        		<tr height="42px;">
						        			<td style="padding-left: 16px;text-align: right;">引字典：</td>
						        			<td><div class="nav-search"><input class="nav-search-input" style="width:210px;" name="dictionariesid" id="dictionariesid" type="text" value="" disabled="disabled" placeholder="(非必录)" title="默认值"/></div></td>
						        			<td style="padding-left: 2px;text-align: left;">
						        				<a class="btn btn-light btn-xs" onclick="selectDid();"  title="获取"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a>
						        				<a class="btn btn-light btn-xs" onclick="deldid();"  title="清空">清</a>
						        			</td>
						        			<td style="float: left;"><p class="text-warning bigger-110 orange" style="padding-top: 10px;">[选择父级 ，子一级作为下拉菜单]</p></td>
						        		</tr>
						        		<tr height="42px;">
					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 10px;">
							<tr>
								...
								<td>
									<select name="FHTYPE" id="FHTYPE" data-placeholder="请选择类型"  style="vertical-align:top;width: 87px;" onchange="selectType(this.value)">

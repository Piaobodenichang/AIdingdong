...
<div class="list-cont">
	<a onclick="javascript:window.location.href='mobilemyleave/list'">
        <ul>
            <li><i class="iconfont icon-liebiao1 list-img-bl"></i></li>
            <li>
            	<span>请假申请</span><i class="iconfont icon-yousvg"></i>
            </li>
        </ul>
    </a>
</div>

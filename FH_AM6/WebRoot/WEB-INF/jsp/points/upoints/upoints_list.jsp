...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="upoints/list.do" method="post" name="Form" id="Form">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<c:if test="${QX.edit == 1 }">
									<a class="btn btn-mini btn-success" onclick="makeAll('确定要清空所有积分吗?');" title="批量清零" >批量清零</a>
									</c:if>
								</td>
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>upoints/goEdit.do?USER_ID='+Id;
			 diag.Width = 450;
			 diag.Height = 355;
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要清空所有积分吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>upoints/updateAll.do?tm='+new Date().getTime(),
						    	data: {DATA_IDS:str},
								dataType:'json',
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>upoints/excel.do';
		}
	</script>

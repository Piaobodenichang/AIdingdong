...
public class Const {
	...
	public static final String FILEPATHGOODSIMG = "C://Users//89205//eclipse-workspace//FH_AM6//WebRoot//img//";        //商品图片上传路径
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(mobile)|(attention)|(uploadFiles)).*";	//不对匹配该值的访问路径拦截（正则）

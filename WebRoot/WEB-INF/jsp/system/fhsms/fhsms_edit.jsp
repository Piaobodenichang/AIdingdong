		...
		<table style="width:98%;margin-top: 10px;margin-left: 9px;" >
			<tr>
				<td style="margin-top:0px;">
					 <div style="float: left;" style="width:81%"><textarea placeholder="请选输入对方用户名,多个请用(;)分号隔开" name="USERNAME" id="USERNAME" rows="1" cols="50" style="width:595px;height:32px;" title="请选输入对方用户名,多个请用(;)分号隔开">${pd.username}</textarea></div>

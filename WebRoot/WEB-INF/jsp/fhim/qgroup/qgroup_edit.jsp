		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="qgroup/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function delP(PATH,QGROUP_ID){
			 if(confirm("确定要删除图片？")){
				var url = "qgroup/deltp.do?PATH="+PATH+"&QGROUP_ID="+QGROUP_ID+"&guid="+new Date().getTime();

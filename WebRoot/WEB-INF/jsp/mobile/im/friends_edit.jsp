...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function save(){
			$("#zhongxin").hide();
			$("#zhongxin2").show();
			var FRIENDS_ID = $("#FRIENDS_ID").val();
			var FGROUP_ID = $("#FGROUP_ID").val();
			$.ajax({
				type: "POST",
				url: '<%=basePath%>mobilefriends/edit.do?tm='+new Date().getTime(),
		    	data: {FRIENDS_ID:FRIENDS_ID,FGROUP_ID:FGROUP_ID},
				dataType:'json',
				cache: false,
		...
		$(function() {
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>mobilefgroup/getFgroup.do?tm='+new Date().getTime(),
		    	data: {},
				dataType:'json',
				cache: false,
				success: function(data){
